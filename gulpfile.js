...
function compile(watch) {
  var bundler = null;
  if (watch) {
    bundler = watchify(browserify('./assets/js/main.js', { debug: true }).transform(babel));
  } else {
    bundler = browserify('./assets/js/main.js', { debug: true }).transform(babel);
  }
...
gulp.task('build', ['sassmin', 'image', 'font', 'static', 'javascript']);